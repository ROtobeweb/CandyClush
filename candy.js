...
var $author$project$CandyCrush3$Generated = function (a) {
	return {$: 'Generated', a: a};
};
var $author$project$CandyCrush3$Waiting = {$: 'Waiting'};
...
var $author$project$CandyCrush3$hSize = 5;
...
var $author$project$CandyCrush3$Position = F2(
	function (x, y) {
		return {x: x, y: y};
	});
var $elm$core$Basics$modBy = _Basics_modBy;
var $author$project$CandyCrush3$newPiece = function (i) {
	return {
		color: 0,
		current: A2($author$project$CandyCrush3$Position, 0, 0),
		matching: false,
		moving: false,
		scaleStartAt: 1,
		start: A2($author$project$CandyCrush3$Position, 0, 0),
		x: A2($elm$core$Basics$modBy, $author$project$CandyCrush3$hSize, i),
		xStartAt: A2($elm$core$Basics$modBy, $author$project$CandyCrush3$hSize, i),
		y: (i / $author$project$CandyCrush3$hSize) | 0,
		yStartAt: (i / $author$project$CandyCrush3$hSize) | 0
	};
};
var $author$project$CandyCrush3$vSize = 5;
var $author$project$CandyCrush3$init = function (_v0) {
	return _Utils_Tuple2(
		{
			conf: A2(
				$elm$core$List$map,
				$author$project$CandyCrush3$newPiece,
				A2($elm$core$List$range, 0, ($author$project$CandyCrush3$hSize * $author$project$CandyCrush3$vSize) - 1)),
			elapsed: 10,
			state: $author$project$CandyCrush3$Waiting
		},
		A2(
			$elm$random$Random$generate,
			$author$project$CandyCrush3$Generated,
			A2(
				$elm$random$Random$list,
				25,
				A2($elm$random$Random$int, 0, 4))));
};
var $author$project$CandyCrush3$Elapsed = function (a) {
	return {$: 'Elapsed', a: a};
};
...
var $author$project$CandyCrush3$subscriptions = function (model) {
	return A2($elm$time$Time$every, 120, $author$project$CandyCrush3$Elapsed);
};
var $author$project$CandyCrush3$Added = function (a) {
	return {$: 'Added', a: a};
};
var $author$project$CandyCrush3$Adding = {$: 'Adding'};
var $author$project$CandyCrush3$Moving = function (a) {
	return {$: 'Moving', a: a};
};
...
var $author$project$CandyCrush3$add1 = F3(
	function (j, rList, model) {
		var column = A2(
			$elm$core$List$filter,
			function (p) {
				return _Utils_eq(p.x, j);
			},
			model.conf);
		var normalized = A2(
			$elm$core$List$map,
			function (p) {
				return _Utils_update(
					p,
					{xStartAt: p.x, yStartAt: p.y});
			},
			column);
		var colors = A2(
			$elm$core$List$take,
			5 - $elm$core$List$length(column),
			rList);
		var addend = A2(
			...
			F2(
				function (i, c) {
					return {
						...
						x: j,
						xStartAt: j,
						y: $elm$core$List$length(column) + i,
						yStartAt: $elm$core$List$length(column) + i
					};
				}),
			colors);
...
var $author$project$CandyCrush3$add = F2(
	function (rList, model) {
		var newconf = $elm$core$List$concat(
			A2(
				$elm$core$List$map,
				function (j) {
					return A3(
						$author$project$CandyCrush3$add1,
						j,
						A2(
							$elm$core$List$take,
							5,
							A2($elm$core$List$drop, 5 * j, rList)),
						model);
				},
		...
		return _Utils_update(
			model,
			{conf: newconf, state: $author$project$CandyCrush3$Waiting});
	});
var $elm$json$Json$Encode$bool = _Json_wrap;
var $author$project$CandyCrush3$Deleting = {$: 'Deleting'};
var $elm$core$Basics$not = _Basics_not;
var $author$project$CandyCrush3$deleteMatch = function (model) {
	return _Utils_update(
		model,
		{
			conf: A2(
				...
				model.conf),
			elapsed: 0,
			state: $author$project$CandyCrush3$Deleting
		});
};
var $elm$core$List$sortBy = _List_sortBy;
var $author$project$CandyCrush3$dropColumn = function (conf) {
	return A2(
		$elm$core$List$indexedMap,
		F2(
			function (i, p) {
...
var $author$project$CandyCrush3$drop1 = F2(
	function (j, model) {
		return $author$project$CandyCrush3$dropColumn(
			A2(
				$elm$core$List$filter,
				function (p) {
					return _Utils_eq(p.x, j);
...
var $author$project$CandyCrush3$drop = function (model) {
	var conf = $elm$core$List$concat(
		A2(
			$elm$core$List$map,
			function (j) {
				return A2($author$project$CandyCrush3$drop1, j, model);
			},
			A2($elm$core$List$range, 0, 4)));
	return _Utils_update(
		model,
...
var $author$project$CandyCrush3$Matching = {$: 'Matching'};
...
var $author$project$CandyCrush3$hMatchAt = F2(
	function (p, model) {
		var right = A2(
			$elm$core$List$filter,
			function (q) {
				return _Utils_eq(q.color, p.color) && (_Utils_eq(q.y, p.y) && (((q.x - p.x) <= 2) && (_Utils_cmp(q.x, p.x) > -1)));
			},
			model.conf);
		var others = A2(
			$elm$core$List$filter,
			...
			model.conf);
		return ($elm$core$List$length(right) >= 3) ? $elm$core$List$concat(
			_List_fromArray(
				[
					A2(
					$elm$core$List$map,
...
var $author$project$CandyCrush3$vMatchAt = F2(
	function (p, model) {
		var others = A2(
			$elm$core$List$filter,
			function (q) {
				return !(_Utils_eq(q.color, p.color) && (_Utils_eq(q.x, p.x) && (((q.y - p.y) <= 2) && (_Utils_cmp(q.y, p.y) > -1))));
			},
			model.conf);
		var below = A2(
			$elm$core$List$filter,
			...
			model.conf);
		return ($elm$core$List$length(below) >= 3) ? $elm$core$List$concat(
			_List_fromArray(
				[
					A2(
					$elm$core$List$map,
...
var $author$project$CandyCrush3$match = function (model) {
	var newconf = A3(
		$elm$core$List$foldl,
		F2(
			function (p, conf) {
				return A2(
					$author$project$CandyCrush3$vMatchAt,
					p,
					_Utils_update(
						model,
						{conf: conf}));
	...
	var newnewconf = A3(
		...
		F2(
			function (p, conf) {
				return A2(
					$author$project$CandyCrush3$hMatchAt,
					p,
					_Utils_update(
						model,
						{conf: conf}));
	...
	var isMatched = A2(
		...
		newnewconf);
	return isMatched ? _Utils_update(
		model,
		{conf: newnewconf, state: $author$project$CandyCrush3$Matching}) : _Utils_update(
		model,
		{state: $author$project$CandyCrush3$Waiting});
};
...
var $author$project$CandyCrush3$randomize = F2(
	function (conf, rlist) {
		return A2(
			$elm$core$List$indexedMap,
			F2(
					...
					return _Utils_update(
						p,
						{
							color: A2(
								...
								0,
								$elm$core$List$head(
									A2($elm$core$List$drop, idx, rlist)))
						});
				}),
			conf);
	});
var $author$project$CandyCrush3$sound = _Platform_outgoingPort('sound', $elm$core$Basics$identity);
var $elm$core$Basics$abs = function (n) {
	return (n < 0) ? (-n) : n;
};
var $author$project$CandyCrush3$swap = F2(
	function (end, model) {
		var _v0 = model.state;
		if (_v0.$ === 'Moving') {
			var start = _v0.a;
			var others = A2(
				$elm$core$List$filter,
				function (p) {
					return ((!_Utils_eq(p.x, end.x)) || (!_Utils_eq(p.y, end.y))) && ((!_Utils_eq(p.x, start.x)) || (!_Utils_eq(p.y, start.y)));
				},
				model.conf);
			var distance = $elm$core$Basics$abs(start.x - end.x) + $elm$core$Basics$abs(start.y - end.y);
			if (distance !== 1) {
				return _Utils_update(
					model,
					{
				...
				var swapped = $author$project$CandyCrush3$match(
					_Utils_update(
						model,
						{
							conf: $elm$core$List$concat(
								_List_fromArray(
									[
										_List_fromArray(
										[
				...
				var existMatching = A3(
					$elm$core$List$foldl,
					F2(
						function (p, matching) {
							return p.matching || matching;
						}),
					false,
					swapped.conf);
				return existMatching ? swapped : _Utils_update(
					model,
					{
						conf: A2(
							$elm$core$List$map,
...
var $author$project$CandyCrush3$unit = 100;
var $author$project$CandyCrush3$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Generated':
				var rlist = msg.a;
				return _Utils_Tuple2(
					$author$project$CandyCrush3$match(
						_Utils_update(
							model,
							{
								conf: A2($author$project$CandyCrush3$randomize, model.conf, rlist)
							})),
			...
			case 'MoveStart':
				...
				var others = A2(
					$elm$core$List$filter,
					function (p) {
						return (!_Utils_eq(piece.x, p.x)) || (!_Utils_eq(piece.y, p.y));
					},
					model.conf);
				var moving = A2(
					$elm$core$List$map,
					function (p) {
						return _Utils_update(
							p,
							{current: pos, moving: true, start: pos});
					},
					A2(
						$elm$core$List$filter,
						function (p) {
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							conf: conf,
							state: $author$project$CandyCrush3$Moving(piece)
						}),
					$elm$core$Platform$Cmd$none);
			case 'MoveEnd':
				var pos = msg.a;
				var newy = $author$project$CandyCrush3$hSize - $elm$core$Basics$floor(pos.y / $author$project$CandyCrush3$unit);
				var newx = $elm$core$Basics$floor(pos.x / $author$project$CandyCrush3$unit);
				var dest = $elm$core$List$head(
					A2(
						$elm$core$List$filter,
						function (p) {
							return _Utils_eq(p.x, newx) && _Utils_eq(p.y, newy);
						},
						model.conf));
				if (dest.$ === 'Just') {
					var piece = dest.a;
					return _Utils_Tuple2(
						$author$project$CandyCrush3$match(
							A2($author$project$CandyCrush3$swap, piece, model)),
						$elm$core$Platform$Cmd$none);
				} else {
			...
			case 'Added':
				var rlist = msg.a;
				return _Utils_Tuple2(
					A2($author$project$CandyCrush3$add, rlist, model),
					$author$project$CandyCrush3$sound(
				...
				switch (_v2.$) {
					case 'Waiting':
						...
						return _Utils_Tuple2(
							...
							$elm$core$Platform$Cmd$none);
					case 'Matching':
						return (model.elapsed > 5) ? _Utils_Tuple2(
							$author$project$CandyCrush3$deleteMatch(model),
					...
					case 'Deleting':
						if (!model.elapsed) {
							var newModel = $author$project$CandyCrush3$drop(model);
							return _Utils_Tuple2(
								_Utils_update(
									newModel,
									{elapsed: newModel.elapsed + 1}),
								$elm$core$Platform$Cmd$none);
						} else {
							if (model.elapsed > 5) {
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{state: $author$project$CandyCrush3$Adding}),
									A2(
										$elm$random$Random$generate,
										$author$project$CandyCrush3$Added,
										A2(
											$elm$random$Random$list,
											25,
											A2($elm$random$Random$int, 0, 4))));
...
var $author$project$CandyCrush3$Move = function (a) {
	return {$: 'Move', a: a};
};
var $author$project$CandyCrush3$MoveEnd = function (a) {
	return {$: 'MoveEnd', a: a};
};
var $author$project$CandyCrush3$MoveStart = F2(
	function (a, b) {
		return {$: 'MoveStart', a: a, b: b};
	});
...
var $author$project$CandyCrush3$animatedSvg = $andrewMacmurray$elm_simple_animation$Simple$Animation$Animated$svg(
	{_class: $elm$svg$Svg$Attributes$class});
var $elm$svg$Svg$trustedNode = _VirtualDom_nodeNS('http://www.w3.org/2000/svg');
var $elm$svg$Svg$g = $elm$svg$Svg$trustedNode('g');
var $author$project$CandyCrush3$animatedG = $author$project$CandyCrush3$animatedSvg($elm$svg$Svg$g);
...
var $author$project$CandyCrush3$fade = function (pos) {
	return A2(
		$andrewMacmurray$elm_simple_animation$Simple$Animation$steps,
		{
			...
			startAt: _List_fromArray(
				[
					$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$x(pos.x),
					$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$y(pos.y)
				])
		},
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$x(0),
						$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$y(0),
						$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$scale(0)
					]))
			]));
};
var $elm$svg$Svg$Attributes$fill = _VirtualDom_attribute('fill');
var $author$project$CandyCrush3$normal = F3(
	function (pos, startPos, startScale) {
		return A2(
			$andrewMacmurray$elm_simple_animation$Simple$Animation$steps,
			{
				options: _List_Nil,
				startAt: _List_fromArray(
					[
						$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$x(startPos.x),
						$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$y(startPos.y),
						$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$scale(startScale)
					])
			},
			_List_fromArray(
				[
...
var $author$project$CandyCrush3$pallet = function (colornum) {
	switch (colornum) {
		case 0:
			return 'violet';
		case 1:
...
var $author$project$CandyCrush3$relativePos = function (event) {
	return {x: event.pointer.offsetPos.a - 100, y: event.pointer.offsetPos.b - 100};
};
...
var $author$project$CandyCrush3$pieceView = function (pdata) {
	var ypixel = pdata.moving ? ((((($author$project$CandyCrush3$hSize * $author$project$CandyCrush3$unit) - (pdata.y * $author$project$CandyCrush3$unit)) + 100) + pdata.current.y) - pdata.start.y) : ((($author$project$CandyCrush3$hSize * $author$project$CandyCrush3$unit) - (pdata.y * $author$project$CandyCrush3$unit)) + 100);
	var xpixel = pdata.moving ? ((((pdata.x * $author$project$CandyCrush3$unit) + 100) + pdata.current.x) - pdata.start.x) : ((pdata.x * $author$project$CandyCrush3$unit) + 100);
	var startYpixel = pdata.moving ? ((((($author$project$CandyCrush3$hSize * $author$project$CandyCrush3$unit) - (pdata.yStartAt * $author$project$CandyCrush3$unit)) + 100) + pdata.current.y) - pdata.start.y) : ((($author$project$CandyCrush3$hSize * $author$project$CandyCrush3$unit) - (pdata.yStartAt * $author$project$CandyCrush3$unit)) + 100);
	var startXpixel = pdata.moving ? ((((pdata.xStartAt * $author$project$CandyCrush3$unit) + 100) + pdata.current.x) - pdata.start.x) : ((pdata.xStartAt * $author$project$CandyCrush3$unit) + 100);
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 2) | 0)),
									$elm$svg$Svg$Attributes$cy(
									$elm$core$String$fromInt(((3 * $author$project$CandyCrush3$unit) / 4) | 0)),
									$elm$svg$Svg$Attributes$r(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 7) | 0)),
									$elm$svg$Svg$Attributes$fill(
									$author$project$CandyCrush3$pallet(color))
								]),
							_List_Nil),
							A2(
							$elm$svg$Svg$circle,
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$cx(
									$elm$core$String$fromInt(((5 * $author$project$CandyCrush3$unit) / 14) | 0)),
									$elm$svg$Svg$Attributes$cy(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 2) | 0)),
									$elm$svg$Svg$Attributes$r(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 7) | 0)),
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$cx(
									$elm$core$String$fromInt(((9 * $author$project$CandyCrush3$unit) / 14) | 0)),
									$elm$svg$Svg$Attributes$cy(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 2) | 0)),
									$elm$svg$Svg$Attributes$r(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 7) | 0)),
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$cx(
									$elm$core$String$fromInt(((3 * $author$project$CandyCrush3$unit) / 14) | 0)),
									$elm$svg$Svg$Attributes$cy(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 4) | 0)),
									$elm$svg$Svg$Attributes$r(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 7) | 0)),
									$elm$svg$Svg$Attributes$fill(
									$author$project$CandyCrush3$pallet(color))
							...
							_List_fromArray(
								[
									...
									$elm$svg$Svg$Attributes$fill(
									$author$project$CandyCrush3$pallet(color)),
									$elm$svg$Svg$Attributes$transform('translate(-0.5, 0)')
								]),
							_List_Nil),
							A2(
							$elm$svg$Svg$circle,
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$cx(
									$elm$core$String$fromInt(((11 * $author$project$CandyCrush3$unit) / 14) | 0)),
									$elm$svg$Svg$Attributes$cy(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 4) | 0)),
									$elm$svg$Svg$Attributes$r(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 7) | 0)),
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$cx(
									$elm$core$String$fromInt(((13 * $author$project$CandyCrush3$unit) / 28) | 0)),
									$elm$svg$Svg$Attributes$cy(
									$elm$core$String$fromInt(((5 * $author$project$CandyCrush3$unit) / 7) | 0)),
									$elm$svg$Svg$Attributes$r(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 25) | 0)),
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$cx(
									$elm$core$String$fromInt(((9 * $author$project$CandyCrush3$unit) / 28) | 0)),
									$elm$svg$Svg$Attributes$cy(
									$elm$core$String$fromInt(((13 * $author$project$CandyCrush3$unit) / 28) | 0)),
									$elm$svg$Svg$Attributes$r(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 25) | 0)),
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$cx(
									$elm$core$String$fromInt(((17 * $author$project$CandyCrush3$unit) / 28) | 0)),
									$elm$svg$Svg$Attributes$cy(
									$elm$core$String$fromInt(((13 * $author$project$CandyCrush3$unit) / 28) | 0)),
									$elm$svg$Svg$Attributes$r(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 25) | 0)),
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$cx(
									$elm$core$String$fromInt(((5 * $author$project$CandyCrush3$unit) / 28) | 0)),
									$elm$svg$Svg$Attributes$cy(
									$elm$core$String$fromInt(((3 * $author$project$CandyCrush3$unit) / 14) | 0)),
									$elm$svg$Svg$Attributes$r(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 25) | 0)),
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$d('M 0 0 c 70 20, 70 80, 0 100 c 50 -30, 50 -70, 0 -100 z'),
									$elm$svg$Svg$Attributes$fill('gold'),
									$elm$svg$Svg$Attributes$transform('scale(0.8, 0.8), translate(90, 20), rotate(45)')
								]),
							_List_Nil),
							A2(
							$elm$svg$Svg$path,
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$d('M 0 0 c 50 30, 50 70, 0 100 c 30 -40, 30 -60, 0 -100 z'),
									$elm$svg$Svg$Attributes$fill(
									$author$project$CandyCrush3$pallet(color)),
									$elm$svg$Svg$Attributes$transform('scale(0.8, 0.8), translate(90, 20), rotate(45)')
								]),
							...
							_List_fromArray(
								[
									...
									$elm$core$String$fromInt(((2 * $author$project$CandyCrush3$unit) / 3) | 0)),
									$elm$svg$Svg$Attributes$y(
									$elm$core$String$fromInt(((2 * $author$project$CandyCrush3$unit) / 15) | 0)),
									$elm$svg$Svg$Attributes$width(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 6) | 0)),
									$elm$svg$Svg$Attributes$height(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 15) | 0)),
									$elm$svg$Svg$Attributes$fill(
									$author$project$CandyCrush3$pallet(color))
								]),
							_List_Nil)
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 2) | 0)),
									$elm$svg$Svg$Attributes$r(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 3) | 0)),
									$elm$svg$Svg$Attributes$fill(
									$author$project$CandyCrush3$pallet(color))
								]),
							_List_Nil),
							...
							_List_fromArray(
								[
									...
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 2) | 0)),
									$elm$svg$Svg$Attributes$cy(
									$elm$core$String$fromInt(((3 * $author$project$CandyCrush3$unit) / 7) | 0)),
									$elm$svg$Svg$Attributes$rx(
									$elm$core$String$fromInt(((4 * $author$project$CandyCrush3$unit) / 11) | 0)),
									$elm$svg$Svg$Attributes$ry(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 30) | 0)),
									$elm$svg$Svg$Attributes$fill(
									$author$project$CandyCrush3$pallet(color))
								]),
							_List_Nil),
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$x(
									$elm$core$String$fromInt(((3 * $author$project$CandyCrush3$unit) / 22) | 0)),
									$elm$svg$Svg$Attributes$y(
									$elm$core$String$fromInt(((3 * $author$project$CandyCrush3$unit) / 7) | 0)),
									$elm$svg$Svg$Attributes$width(
									$elm$core$String$fromInt(((8 * $author$project$CandyCrush3$unit) / 11) | 0)),
									$elm$svg$Svg$Attributes$height(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 7) | 0)),
									$elm$svg$Svg$Attributes$fill(
									$author$project$CandyCrush3$pallet(color)),
									$elm$svg$Svg$Attributes$transform('translate(1, 0.5)')
								]),
							_List_Nil),
							A2(
							$elm$svg$Svg$ellipse,
							_List_fromArray(
								[
									...
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 2) | 0)),
									$elm$svg$Svg$Attributes$cy(
									$elm$core$String$fromInt(((4 * $author$project$CandyCrush3$unit) / 7) | 0)),
									$elm$svg$Svg$Attributes$rx(
									$elm$core$String$fromInt(((4 * $author$project$CandyCrush3$unit) / 11) | 0)),
									$elm$svg$Svg$Attributes$ry(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 30) | 0)),
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$cx(
									$elm$core$String$fromInt(((4 * $author$project$CandyCrush3$unit) / 10) | 0)),
									$elm$svg$Svg$Attributes$cy(
									$elm$core$String$fromInt(((4 * $author$project$CandyCrush3$unit) / 10) | 0)),
									$elm$svg$Svg$Attributes$r(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 10) | 0)),
									$elm$svg$Svg$Attributes$fill('white')
								]),
							_List_Nil)
						]));
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$x(
									$elm$core$String$fromInt(((9 * $author$project$CandyCrush3$unit) / 20) | 0)),
									$elm$svg$Svg$Attributes$y(
									$elm$core$String$fromInt(((2 * $author$project$CandyCrush3$unit) / 15) | 0)),
									$elm$svg$Svg$Attributes$width(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 15) | 0)),
									$elm$svg$Svg$Attributes$height(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 5) | 0)),
									$elm$svg$Svg$Attributes$fill(
									$author$project$CandyCrush3$pallet(color))
								]),
							_List_Nil),
							...
							_List_fromArray(
								[
									...
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 2) | 0)),
									$elm$svg$Svg$Attributes$cy(
									$elm$core$String$fromInt(((3 * $author$project$CandyCrush3$unit) / 5) | 0)),
									$elm$svg$Svg$Attributes$r(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 3) | 0)),
									$elm$svg$Svg$Attributes$fill(
									$author$project$CandyCrush3$pallet(color))
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$d('M 40 40 L 70 70')
								]),
							_List_Nil)
						]));
			case 4:
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 15) | 0)),
									$elm$svg$Svg$Attributes$ry(
									$elm$core$String$fromInt(($author$project$CandyCrush3$unit / 32) | 0)),
	...
	var anim = pdata.matching ? $author$project$CandyCrush3$fade(
		{x: xpixel, y: ypixel}) : A3(
		$author$project$CandyCrush3$normal,
		{x: xpixel, y: ypixel},
		{x: startXpixel, y: startYpixel},
		pdata.scaleStartAt);
	return A3(
		$author$project$CandyCrush3$animatedG,
		anim,
		_List_fromArray(
			[
				$elm$svg$Svg$Attributes$transform(
				'translate(' + ($elm$core$String$fromFloat(xpixel) + (',' + ($elm$core$String$fromFloat(ypixel) + ')')))),
				$mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$onDown(
				A2(
					$elm$core$Basics$composeR,
					$author$project$CandyCrush3$relativePos,
					$author$project$CandyCrush3$MoveStart(pdata))),
				$mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$onMove(
				A2($elm$core$Basics$composeR, $author$project$CandyCrush3$relativePos, $author$project$CandyCrush3$Move)),
				$mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$onUp(
				A2($elm$core$Basics$composeR, $author$project$CandyCrush3$relativePos, $author$project$CandyCrush3$MoveEnd))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$width(
						$elm$core$String$fromInt($author$project$CandyCrush3$unit)),
						$elm$svg$Svg$Attributes$height(
						$elm$core$String$fromInt($author$project$CandyCrush3$unit)),
						$elm$svg$Svg$Attributes$stroke('white'),
						$elm$svg$Svg$Attributes$strokeWidth('4px'),
						$elm$svg$Svg$Attributes$fill(
						pdata.matching ? 'red' : '#aaa')
					]),
				_List_Nil),
				shape(pdata.color)
			]));
...
var $author$project$CandyCrush3$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$CandyCrush3$pieceView,
					A2(
						$elm$core$List$sortBy,
						function (p) {
							return p.matching ? 1 : 0;
						},
						model.conf)))
			]));
};
var $author$project$CandyCrush3$main = $elm$browser$Browser$element(
	{init: $author$project$CandyCrush3$init, subscriptions: $author$project$CandyCrush3$subscriptions, update: $author$project$CandyCrush3$update, view: $author$project$CandyCrush3$view});
_Platform_export({'CandyCrush3':{'init':$author$project$CandyCrush3$main(
